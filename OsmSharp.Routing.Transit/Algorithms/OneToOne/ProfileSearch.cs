...
//        /// </summary>
//        public ProfileSearch(TransitDb db, uint sourceStop, uint targetStop, DateTime departureTime,
//            int minimumTransferTime, int maxmumSearchTime, Func<uint, DateTime, bool> isTripPossible)
//        {
//            _db = db;
//            _sourceStop = sourceStop;
//            _targetStop = targetStop;
...
//        /// </summary>
//        private Dictionary<uint, ProfileCollection> _profiles;
...
//            _profiles = new Dictionary<uint, ProfileCollection>();
