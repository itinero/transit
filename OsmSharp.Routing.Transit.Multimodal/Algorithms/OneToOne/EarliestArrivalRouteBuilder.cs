...
namespace OsmSharp.Routing.Transit.Multimodal.Algorithms.OneToOne
{
    ...
    public class EarliestArrivalRouteBuilder : OneToOneRouteBuilder<EarliestArrival>
    {
        private MultimodalConnectionsDb _db;
        ...
        public EarliestArrivalRouteBuilder(EarliestArrival earliestArrival, MultimodalConnectionsDb db)
        ...
        {
            var stops = new List<Tuple<int, EarliestArrival.StopStatus>>();
            ...
            stops.Insert(0, new Tuple<int, EarliestArrival.StopStatus>(bestTargetStop, status));
            ...
            { // keep searching until the connection id < 0, meaning the start status, without a previous trip.
                ...
                { // this stop has no trip, this means that it is the first stop.
                    ...
                    stops.Insert(0, new Tuple<int, EarliestArrival.StopStatus>(
