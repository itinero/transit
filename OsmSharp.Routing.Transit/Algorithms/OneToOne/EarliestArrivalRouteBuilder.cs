...
namespace OsmSharp.Routing.Transit.Algorithms.OneToOne
{
    ...
    public class EarliestArrivalRouteBuilder : OneToOneRoutingAlgorithmRouteBuilder<EarliestArrival>
    {
        /// <summary>
        ...
        public EarliestArrivalRouteBuilder(EarliestArrival earliestArrival, GTFSConnectionsDb connectionsDb)
        ...
        public override Route DoBuild()
        {
            ...
            { // keep searching until the connection id < 0, meaning the start status, without a previous trip.
                ...
                { // this stop has no trip, this means that it is the first stop.
                    ...
                    var statusWithTrip = new StopStatus()
                    {
                        ConnectionId = -1,
