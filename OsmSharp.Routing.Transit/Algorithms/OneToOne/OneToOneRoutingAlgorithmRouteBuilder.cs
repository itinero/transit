...
namespace OsmSharp.Routing.Transit.Algorithms.OneToOne
{
    ...
    public abstract class OneToOneRoutingAlgorithmRouteBuilder<T>
        where T : OneToOneRoutingAlgorithmBase
    {
        /// <summary>
        ...
        public OneToOneRoutingAlgorithmRouteBuilder(T algorithm)
        {
