...
//{
//    /// <summary>
//    /// Containts tests for the one-to-many profile search.
//    /// </summary>
//    [TestFixture]
//    public class OneToManyProfileSearchTests
//    {
//        /// <summary>
...
//            Assert.AreEqual(40 * 60, algorithm.Duration(0));
//            Assert.AreEqual(new DateTime(2017, 05, 10, 08, 10, 00), algorithm.ArrivalTime(0));
...
//            Assert.IsTrue(algorithm.HasRun);
//            Assert.IsTrue(algorithm.HasSucceeded);
//            Assert.AreEqual(50 * 60, algorithm.Duration(0));
//            Assert.AreEqual(new DateTime(2017, 05, 10, 08, 20, 00), algorithm.ArrivalTime(0));
...
//            Assert.IsTrue(algorithm.HasRun);
//            Assert.IsTrue(algorithm.HasSucceeded);
//            Assert.AreEqual(55 * 60, algorithm.Duration(0));
//            Assert.AreEqual(new DateTime(2017, 05, 10, 08, 25, 00), algorithm.ArrivalTime(0));
...
//            Assert.AreEqual(duration, algorithm.Duration(0));
//            Assert.AreEqual(new DateTime(2017, 05, 10, 07, 30, 00).AddSeconds(duration), algorithm.ArrivalTime(0));
...
//            Assert.IsTrue(algorithm.HasRun);
//            Assert.IsTrue(algorithm.HasSucceeded);
//            Assert.IsTrue(algorithm.GetHasTransit(0));
//            var duration500m = (int)(500 / ((OsmSharp.Units.Speed.MeterPerSecond)Vehicle.Pedestrian.ProbableSpeed(tagsIndex.Get(tagsId))).Value);
//            var duration = 40 * 60 + duration500m;
//            Assert.AreEqual(duration, algorithm.Duration(0));
//            Assert.AreEqual(new DateTime(2017, 05, 10, 07, 30, 00).AddSeconds(duration), algorithm.ArrivalTime(0));
...
//            Assert.IsTrue(algorithm.HasRun);
//            Assert.IsTrue(algorithm.HasSucceeded);
//            Assert.IsFalse(algorithm.GetHasTransit(0));
//        }
...
//            Assert.AreEqual(duration, algorithm.Duration(0), 1);
//            Assert.AreEqual(new DateTime(2017, 05, 10, 07, 30, 00).AddSeconds(duration), algorithm.ArrivalTime(0));
...
//            Assert.IsTrue(algorithm.HasSucceeded);
//            Assert.IsFalse(algorithm.GetHasTransit(0));
//            Assert.AreEqual(2, algorithm.GetBestNonTransitVertex(0));
//        }
