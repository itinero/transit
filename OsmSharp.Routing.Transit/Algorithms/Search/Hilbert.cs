...
namespace OsmSharp.Routing.Transit.Algorithms.Search
{
    /// <summary>
    ...
    public static class Hilbert
    {
        ...
        public static HashSet<uint> Search(this StopsDb.Enumerator stopsDbEnumerator, float latitude, float longitude,
            float offset)
        {
            return Hilbert.Search(stopsDbEnumerator, OsmSharp.Routing.Algorithms.Search.Hilbert.DefaultHilbertSteps, latitude - offset, longitude - offset,
        ...
        {
            return stopsDbEnumerator.Search(OsmSharp.Routing.Algorithms.Search.Hilbert.DefaultHilbertSteps, minLatitude, minLongitude,
