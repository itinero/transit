...
namespace OsmSharp.Routing.Transit.Test.Profiles
{
    /// <summary>
    /// A profile mock.
    /// </summary>
    public class MockProfile : Profile
    {
        ...
        private MockProfile(string name, Func<TagsCollectionBase, Speed> getSpeed,
            ...
            : base(name, getSpeed, () => new Speed() { Value = 5, Direction = 0 }, x => true, (e1, e2) => true, 
                vehicleTypes, ProfileMetric.TimeInSeconds)
        {
