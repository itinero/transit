...
//namespace OsmSharp.Routing.Transit.MultiModal.Streams
//{
//    /// <summary>
//    /// A data processing target containing edges with the orignal OSM-tags and their original OSM-direction.
//    /// </summary>
//    public class MultiModalGraphOsmStreamTarget : DynamicGraphOsmStreamWriter<LiveEdge>
//    {
//        /// <summary>
...
//        public MultiModalGraphOsmStreamTarget(IDynamicGraphRouterDataSource<LiveEdge> dynamicGraph,
...
//        /// <returns></returns>
//        protected override MultiModalEdge CalculateEdgeData(IEdgeInterpreter edgeInterpreter, ITagsCollectionIndex tagsIndex,
...
//        /// <param name="interpreter"></param>
//        /// <returns></returns>
//        public static DynamicGraphRouterDataSource<MultiModalEdge> Preprocess(OsmStreamSource reader,
//                                                                        ITagsCollectionIndex tagsIndex,
//                                                                        IOsmRoutingInterpreter interpreter)
//        {
//            var dynamicGraphRouterDataSource =
//                new DynamicGraphRouterDataSource<MultiModalEdge>(tagsIndex);
//            var targetData = new MultiModalGraphOsmStreamTarget(dynamicGraphRouterDataSource, interpreter,
//                tagsIndex);
...
//                                                                        IOsmRoutingInterpreter interpreter)
//        {
//            return MultiModalGraphOsmStreamTarget.Preprocess(reader, new TagsTableCollectionIndex(), interpreter);
//        }
