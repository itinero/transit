...
namespace OsmSharp.Routing.Transit
{
    ...
    public class TransitRouter
    {
        ...
        ///// </summary>
        ///// <param name="fromFeedId">The feed id of the feed containing the source stop.</param>
        ///// <param name="fromStop">The source stop id.</param>
        ///// <param name="toFeedId">The feed id of the feed containing the target stop.</param>
        ///// <param name="toStop">The target stop id.</param>
        ///// <param name="departureTime">The departure time.</param>
        ///// <returns></returns>
        //public TransitRoute Calculate(int fromFeedId, string fromStop, int toFeedId, string toStop, 
