...
namespace OsmSharp.Transit.Test
{
    ...
    public class MockProfile : Profile
    {
        ...
        private MockProfile(string name, Func<TagsCollectionBase, Speed> getSpeed,
            ...
            : base(name, getSpeed, x => true, (e1, e2) => true, vehicleTypes, ProfileMetric.TimeInSeconds)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static MockProfile CarMock(Func<TagsCollectionBase, Speed> speed)
        {
            return MockProfile.Mock("CarMock", speed, VehicleTypes.MotorVehicle, VehicleTypes.Vehicle);
        }
